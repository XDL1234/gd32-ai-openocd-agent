...
| `.gd32-agent/config.env` | 工具路径和串口配置 |
| `.gd32-agent/openocd.cfg` | OpenOCD 配置文件 |
| `.gd32-agent/build.sh` | 编译脚本 |
...
| `.gd32-agent/verify-hardware.sh` | 硬件一致性检查 |
| `.gd32-agent/detect-serial.sh` | 串口自动检测 |
| `.gd32-agent/log-with-timestamp.sh` | 日志记录脚本 |
